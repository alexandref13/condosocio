...
Widget listaVideos(BuildContext context) {
  final AlvoTvController alvoTv = Get.put(AlvoTvController());
  ...
  return Container(
    ...
    child: SmartRefresher(
      ...
      child: Obx(() {
        final videos = alvoTv.videos;

        if (alvoTv.isLoading.value && videos.isEmpty) {
...
class _CondoPlayFeaturedCard extends StatelessWidget {
  final dynamic video;
  final ValueChanged<String> onTap;

  const _CondoPlayFeaturedCard({
    required this.video,
    required this.onTap,
  });
...
class _CondoPlayVideoCard extends StatelessWidget {
  final dynamic video;
  final ValueChanged<String> onTap;

  const _CondoPlayVideoCard({
    required this.video,
    required this.onTap,
  });
